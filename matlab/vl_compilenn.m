...
% opts.cudaRoot         = '/usr/local/cuda-10.0' ;
opts.cudaRoot         = '/usr/local/cuda-9.2' ;
opts.cudaArch         =...
...
opts.mexConfig        = '' ;
opts.mexCudaConfig    = '' ;
% opts.cudnnRoot        = '/usr/local/cudnn/v7_4_1_cuda10/cuda' ;
opts.cudnnRoot        = '/usr/local/cudnn/v7_3_1_cuda9_2/cuda' ;
opts.preCompileFn       = [] ;
...
lib_src{end+1} = fullfile(root,'matlab','src','bits',['nnimsn_cov.' ext]) ;
...
mex_src{end+1} = fullfile(root,'matlab','src',['vl_nnimsn_cov.' ext]) ;
...
lib_src{end+1} = fullfile(root,'matlab','src','bits','impl','imsn_cov_cpu.cpp') ;
...
if opts.enableGpu
  ...
  lib_src{end+1} = fullfile(root,'matlab','src','bits','impl','imsn_cov_gpu.cu') ;

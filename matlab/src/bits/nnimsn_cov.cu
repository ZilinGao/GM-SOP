...
#include "nnimsn_cov.hpp"
#include "impl/nnimsn_cov_blas.hpp"
#if ENABLE_CUDNN
#include "impl/nnimsn_cov_blas.hpp" // cudnn -> blas
#endif
#include <assert.h>
...
error = vl::impl::imsn_cov<deviceType, type, dataType>::forward \
(context, \
...
vl::ErrorCode
vl::nnimsn_cov_forward(vl::Context& context,
                       vl::Tensor output,
                       vl::Tensor data,
                       vl::Tensor aux_Y,
                       vl::Tensor aux_Z,
...
#undef DISPATCH
#define DISPATCH(deviceType, type, dataType) \
error = vl::impl::imsn_cov<deviceType, type, dataType>::backward \
(context, \
...
vl::ErrorCode
vl::nnimsn_cov_backward(vl::Context& context,
                       vl::Tensor derData,
                       vl::Tensor data,
                       vl::Tensor derOutput,
                       vl::Tensor aux_Y,

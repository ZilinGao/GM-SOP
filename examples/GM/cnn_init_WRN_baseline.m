function net = cnn_init_WRN_baseline(varargin)
...
if ~(strcmp(opts.modelType,'WRN-36-2-GAP') |  ...
        strcmp(opts.modelType, 'WRN-36-2-SR-SOP'))
...
lastAdded.depth = 2^(s+2) * opts.width_times;
   ...
   CM_name = [];
    if opts.order == 2
        ...
        lastAdded.var = [CM_name 'Cov_ScaleTr'] ;
    else
...
switch opts.modelType
    ...
    case 'WRN-36-2-SR-SOP'
        lr =  1 * [0.1 * ones(1,10), 0.01*ones(1,10), 0.001*ones(1,10)] ;
end

function net = cnn_init_WRN_GM_v2(varargin)
...
switch opts.modelType
    ...
    case 'WRN-36-2-GM-SOP'
        lr =  1 * [0.1 * ones(1,20), 0.01*ones(1,10), 0.001*ones(1,5),0.0001*ones(1,5)] ;
end
folder = strcat(folder , 'dr0.6-LR_',num2str(lr(1)) , '_w_' , num2str(opts.loss_w));

...
g_id = net.getVarIndex('gating');
if ~isnan(g_id)
    net.vars(g_id).precious = true;  
    % adjust execution order for the multi-branch model
...
for t=1:params.batchSize:numel(subset)
    ...
    for s=1:params.numSubBatches
        ...
        %data-aug: random flip
        inputs = params.getBatch(params.imdb, batch, 'mode', mode);
    ...
    if ~isnan(net.getLayerIndex( 'Balance_loss'))
        stats.BalanceLoss =gather( net.vars(net.getVarIndex('Balance_loss')).value{1});
    end
